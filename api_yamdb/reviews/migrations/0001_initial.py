# Generated by Django 3.2 on 2023-08-29 16:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator(message='Недопустимые символы: ^[-a-zA-Z0-9_]+$', regex='^[-a-zA-Z0-9_]+$')], verbose_name='URL-идентификатор')),
            ],
            options={
